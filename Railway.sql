...
VALUES
('Mostafa','A','Abdelfattah','M',12345678925426,01003993985,'12-12-1998');

INSERT INTO LOGIN_PASSENGER
VALUES
(12345678925426,'Mostafa123','12345678');

Select * from PASSENGER P,LOGIN_PASSENGER LP WHERE Username='Mostafa123' and password='12345678' and LP.P_SSN=P.P_SSN;
