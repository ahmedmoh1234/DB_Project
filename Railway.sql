...
VALUES
('Moaz','m','elsherbini','M',1,01018711747,'2001/10/03'),
('Mooaz','m','elsherbini','M',2,01018711748,'2002/10/03'),
('Moaaz','m','elsherbini','M',3,01018711749,'2003/10/03');



INSERT INTO BOOKINGS (P_SSN,Trip_Number,Trip_Date,[Type],[Status])
VALUES
(1,10,'2021/01/10','ECONOMIC','upcoming'),
(2,10,'2021/01/10','ECONOMIC','upcoming'),
(3,10,'2021/01/10','ECONOMIC','upcoming'),
(1,5,'2021/01/08','Business','Completed'),
(2,5,'2021/01/08','Business','Completed'),
(3,5,'2021/01/08','Business','Completed');
...
INSERT INTO STATION
VALUES
('Mohamed',1,'ahmad',12345678,'2021/01/10'),
('Mohamed',2,'ahmad',420420420,'2021/01/10')
